...
<h4 style="padding: 0;margin: 0;">Requests Quota Products Supplier</h4>
<br>
<div class="main-quiz-user">
    ...
    <table>
        ...
        while ($query_quiz->have_posts()) {
            ...
            $proposal_brand = ($proposal) ? get_post_meta($proposal->ID, 'brand', true) : '';
            $proposal_country = ($proposal) ? get_post_meta($proposal->ID, 'country', true) : '';
            $proposal_notes = ($proposal) ? $proposal->post_content : '';
            $proposal_term = ($proposal) ? get_post_meta($proposal->ID, 'term', true) : '';
        ...
        ?>
            ...
            <tr>
                ...
                <td><?= $user ?></td>
                <td class="proposal_<?= $proposal_status ?> status_<?= get_post_meta($proposal->ID, 'status', true) ?>"><?= $proposal_status ?></td>
